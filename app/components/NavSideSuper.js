...
import { faListUl, faTableCellsLarge, faUser, faClipboardList, faUserPlus, faGear, faMoneyCheckAlt, faLayerGroup, faAddressBook, faSquarePlus, faBuilding, faAngleUp,faRefresh } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link href="/vectorSuper" className="flex items-center p-2 text-gray-950 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group mr-2">
                                ...
                                <span className="ml-3 pl-1">Dashboard</span>
                            </Link>
                        </li>
                        ...
                        <li>
                            <button onClick={toggleAdmin} className="flex items-center w-full p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
                                ...
                                />
                                <span className="ml-3 pl-2">Company</span>
                        ...
                        <li>
                            <button onClick={toggleEmployee} className="flex items-center w-full p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
                                ...
                                <FontAwesomeIcon icon={faAngleUp} className={`w-5 h-5 ml-auto ${isEmployeeOpen ? 'rotate-0' : 'rotate-180'}`} />
                            </button>
                            {isEmployeeOpen && (
                                <ul className="ml-6 space-y-2 font-medium text-sm">
                                    <li>
                                        <Link href="/empList" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group">
                                            <FontAwesomeIcon icon={faClipboardList} size='xl'
                                                style={{ color: 'blue', marginLeft: '17px' }}
                                                onClick={() => handleDeleteClick(company._id)}
                                            />
                                            <span className='ml-5'>Admin List </span>
                        ...
                        <li>
                            <button onClick={toggleSetting} className="flex items-center w-full p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group mr-2" >
                                <FontAwesomeIcon icon={faGear} size='xl'
                                    style={{ color: "#2d62be", marginLeft: '5px' }} />
                            ...
                            {isSettingOpen && (
                                <ul className="ml-6 space-y-2 font-medium text-sm">
                                    ...
                                    {/* <li>
                                        <Link href="/register" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover-bg-gray-700 group">

                                            <FontAwesomeIcon icon={faAddressBook} size='xl'
                                                style={{ color: '#1F618D', marginLeft: '19px' }}
                                            />
                                            <span className='ml-5'>Registration</span>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="/subscription" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover-bg-gray-700 group">

                                            <FontAwesomeIcon icon={faLayerGroup} size='xl'
                                                style={{ color: '#ec1313', marginLeft: '19px' }}
                                            />
                                            <span className='ml-5'>Subscription</span>
                                        </Link>
                                    </li> */}
                                    <li>
                                        <Link href="/setAmount" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover-bg-gray-700 group">

                                            <FontAwesomeIcon icon={faMoneyCheckAlt} size='xl'
                                                style={{ color: '#000066', marginLeft: '15px' }}
                                            />
                                            <span className='ml-5'>Set Amount</span>
                                        </Link>
                                    </li>
                                    <li>
                                        <Link href="/renew" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover-bg-gray-700 group">

                                            <FontAwesomeIcon icon={faRefresh} size='xl'
                                                style={{ color: '#000066', marginLeft: '15px' }}
                                            />
                                            <span className='ml-6'>Renew</span>
                                        </Link>
                                    </li>
                                </ul>
                            )}
