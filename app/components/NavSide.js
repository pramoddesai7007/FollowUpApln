                        ...
                        <li>
                            ...
                            {isEmployeeOpen && (
                                <ul className="ml-6 space-y-2 font-medium text-sm">
                                    ...
                                    {/* <li>
                                        <Link href="/salary" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-200 dark:hover:bg-gray-700 group pl-3">
                                            <FontAwesomeIcon icon={faMoneyCheckDollar} size='xl' style={{ color: "blue", marginLeft: '12px' }} />
                                            <span className="ml-2 pl-2">Calculate Salary</span>
                                        </Link>
